...
public class Address {
    ...
    @NotBlank
    @Size(min = 2, message = "City name must be 4 characters")
    private String city;

    @NotBlank
    @Size(min = 2, message = "State name must be 5 characters")
    private String state;

    @NotBlank
    @Size(min = 2, message = "Country name must be 5 characters")
